    ...
    <section className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b-2 border-[#18181B] pb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-[12px] font-black uppercase tracking-widest text-[#E11D48] block">
          ...
          {VERIFIED_FEATURED_TRIPS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`text-[12px] px-1 py-0.5 rounded-xs font-mono font-bold ${
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-2 border-[#18181B] pb-6">
            <div className="space-y-1">
              <div className="flex flex-wrap items-center gap-2">
                <span className="comic-tag bg-[#18181B] text-white text-[12px] font-black">
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1 text-xs">
                        <div className="flex items-center gap-2">
                          <span className="w-6 h-6 bg-[#E11D48] text-white border border-[#18181B] rounded-xs flex items-center justify-center font-black text-[12px]">
                            {idx + 1}
                          </span>
                      ...
                      <div>
                        ...
                        {a.place?.formattedAddress && (
                          <p className="text-[12px] text-[#52525B] font-medium flex items-center gap-1 mt-0.5">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 pt-1 border-t border-zinc-200">
                        <div className="flex items-center gap-2">
                          {a.travelTimeFromPreviousMinutes > 0 && (
                            <span className="text-[12px] font-bold text-[#18181B] bg-amber-100 border border-[#18181B] px-1.5 py-0.5 rounded-xs">
                          ...
                          <a
                            ...
                            className="text-[12px] font-bold text-[#52525B] hover:text-[#E11D48] flex items-center gap-1 min-h-11 py-1"
                          >
                        ...
                        <button
                          ...
                          className="text-[12px] font-black uppercase tracking-wider text-[#18181B] flex items-center gap-1 hover:text-[#E11D48] min-h-11 px-2 py-1"
                        >
                      ...
                      {/* Receipt Drawer */}
                      {isReceiptOpen && (
                        <div className="mt-2 pt-2 border-t-2 border-[#18181B] bg-[#FAF8F5] p-3 rounded-lg space-y-1.5 text-[12px]">
                          <div className="flex items-center justify-between text-[12px] font-black uppercase tracking-wider text-[#52525B] border-b border-zinc-300 pb-1 mb-1.5">
                            <span>Check</span>
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-1.5 shrink-0">
                                  <span className="font-mono text-[12px] uppercase px-1 py-0.2 bg-white border border-[#18181B] rounded-xs font-bold text-[#18181B]">
                                    {c.source}
                                  </span>
                                  <span
